 ...
 * @property RestauranteCategorii[] $restauranteCategoriis
 */
...
//            }
   ...
   public function fields() {
		...
		return $model->produses;
	};
        return $fields;
    }
    
     /**
     * Gets query for [[RestauranteCategoriis]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getRestauranteCategoriis()
    {
        return $this->hasMany(RestauranteCategorii::class, ['categorie' => 'id']);
    }
