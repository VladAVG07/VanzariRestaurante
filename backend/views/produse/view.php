            ...
            <div class="row">
                <div class="col-md-12">
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    if (count($model->produseDetalii) > 1) {
                                        return sprintf('%s - %s RON', $model->produseDetalii[0]->pret, $model->produseDetalii[$lng - 1]->pret);
                                    }
                                    return sprintf('%s RON', $model->produseDetalii[0]->pret);
                                },
                            ],
                            // [
                            //     'attribute' => 'stoc',
                    ...
                    <?= Html::a(Yii::t('app', 'Actualizeaza'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
                        ...
                        ?>
                        <?= Html::a(Yii::t('app', 'Creaza produs nou'), ['create'], ['class' => 'btn btn-success']) ?>
                        <?= Html::a('<i class="far fa-copy" style="color: #ffffff;"></i> Copiaza detalii', ['produse/create', 'id'=>$model->id], ['class' => 'btn btn-dark'])?>
                    </p>
